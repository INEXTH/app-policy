...
const BluetoothPrivacyPolicy: React.FC<Props> = ({ appName, contact }) => {
  return (
    <div className="max-w-7xl">
      ...
      <div className="text-xl mt-4">The Bluetooth permission is used solely to facilitate the functionality of the App, allowing it to communicate and establish connections with external devices. No information is collected, stored, or transmitted from the user's device during this process.</div>
...
export default BluetoothPrivacyPolicy;
